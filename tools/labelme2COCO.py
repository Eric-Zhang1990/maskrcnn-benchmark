...
class labelme2coco(object):
    ...
    def image(self,data,num):
        ...
        img = cv2.imread(os.path.join('/home/zhuqiang/标注数据/铁路标注json (2)/',data['imagePath']), 0)
...
labelme_json=glob.glob('/home/zhuqiang/标注数据/铁路标注json (2)/*.json')
# labelme_json=['./1.json']

labelme2coco(labelme_json,'/home/zhuqiang/标注数据/铁路标注json_coco/railway_coco.json')
